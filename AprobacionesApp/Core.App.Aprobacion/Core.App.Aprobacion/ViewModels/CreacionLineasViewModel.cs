...
{
    public class CreacionLineasViewModel : BaseViewModel
    {
        ...
        public string Barco
        {
            get { return this._Barco; }
            set
            {
                SetValue(ref this._Barco, value);
                Buscar();
            }
        }
        public string Viaje
        {
            get { return this._Viaje; }
            set
            {
                SetValue(ref this._Viaje, value);
                Buscar();
            }
        }
        #endregion
        ...
        public async void LoadLista()
        {
            ...
            try
            {
                ...
                parameters += "&BARCO=" + Barco;
                parameters += "&VIAJE=" + Viaje;
