namespace Core.App.Aprobacion.ViewModels
{
    ...
    public class AprobacionOrdenViewModel : BaseViewModel
    {
        #region Variables
        ...
        public AprobacionOrdenViewModel()
        {
            Color = "Black";
            this.IsEnabled = true;
            this.IsRunning = false;
        ...
        private async void CargarOrden()
        {
            try
            {
                ...
                var response_cs = await apiService.GetObject<OrdenModel>(Settings.UrlConexionActual, Settings.RutaCarpeta, "AprobacionOrden", "CINV_LOGIN="+Settings.IdUsuario);
